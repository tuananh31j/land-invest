  ...
  return (
    <div className='home-container'>
      ...
      <div style={{ position: 'absolute', top: 80, left: 10, zIndex: 1,background: 'white', padding: 10, borderRadius: 4 }}>
        ...
        <div className="slider-container" style={{ position: 'absolute', top: 65, right: 10, zIndex: 1, padding: 10, borderRadius: 4 }}>
        ...
        <div className="container-header" style={{ position: 'absolute', top: 65,  zIndex: 1, padding: 10, background: "#ccc", borderRadius: 4 }}>
            <div className='slider-container-range'>
            <select id="mySelect">
              <option value="option1">Thửa đã lưu</option>

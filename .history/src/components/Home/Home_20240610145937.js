  ...
  return (
    <div className='home-container'>
      ...
      <div style={{ position: 'absolute', top: 80, left: 10, zIndex: 1,background: 'white', padding: 10, borderRadius: 4 }}>
        ...
        <div className="slider-container" style={{ position: 'absolute', top: 100, left: 10, zIndex: 1, padding: 10, background: 'white', borderRadius: 4 }}>
            <div className='slider-container-range'>
                <CiCirclePlus onClick={increaseValue}/>
                <input
                type="range"
                className="slider"
                ...
                />
                <GrSubtractCircle onClick={decreaseValue}/>
            </div>
        </div>
      <GoogleMap

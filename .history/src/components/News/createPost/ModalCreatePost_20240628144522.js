                    ...
                    <div className="post-new">
                        ...
                        <div>
                            <textarea
                                ...
                                style={{ cursor: 'pointer',padding:'8px 20px', margin:'auto 0' , height:'40px', lineHeight:'0', border:'solid 1px #ccc' }}
                            ></textarea>
                            <textarea
                                className="post-new-input"
                                ...
                                style={{ cursor: 'pointer',padding:'8px 20px', border:'solid 1px #ccc',marginTop:'20px' }}
                            ></textarea>
                        </div>

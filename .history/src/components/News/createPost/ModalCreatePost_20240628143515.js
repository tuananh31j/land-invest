...
const ModalCreatePost = (props) => {
    ...
    const adjustTextareaHeightContent = () => {
        const textarea = textareaRefContent.current;
        if (textarea) {
            textarea.style.height = '40px';
            textarea.style.height = `${textarea.scrollHeight}px`;
                    ...
                    <div className="post-new">
                        ...
                        <div>
                            <textarea
                                ...
                                style={{ cursor: 'pointer', lineHeight: '40px',padding:'8px 20px', border:'solid 1px #ccc' }}
                            ></textarea>
                            <textarea
                                className="post-new-input"
                                onChange={handleInputChange}
                                ...
                                style={{ cursor: 'pointer', lineHeight: '40px',padding:'8px 20px', border:'solid 1px #ccc',marginTop:'20px' }}
                            ></textarea>
                        </div>

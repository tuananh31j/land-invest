                    ...
                    <div className="post-new">
                        ...
                        <textarea
                            ...
                            style={{
                                cursor: 'pointer',
                                height: '100px',
                                lineHeight: '100px', // Adjust this value to match the height
                                textAlign: 'center', // Center the placeholder horizontally
                                padding: '0 10px' // Adjust padding to keep some space around the text
                            }}
                        ></textarea>
                        {showSecondTextarea && (
                            <textarea
                                ...
                                style={{
                                    ...
                                    marginTop: '10px',
                                    height: '200px',
                                    lineHeight: '200px', // Adjust this value to match the height
                                    textAlign: 'center', // Center the placeholder horizontally
                                    padding: '0 10px' // Adjust padding to keep some space around the text
                                }}
                            ></textarea>

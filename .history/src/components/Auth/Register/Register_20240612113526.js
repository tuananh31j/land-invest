...
const Register = () => {
  ...
  const [registerLatitude, setRegisterLatitude] = useState(24);
  const [registerLongitude, setRegisterLongitude] = useState(24);
  const [registeravatarLink, setRegisteravatarLink] = useState(24);
  const [registerEmail, setRegisterEmail] = useState("");
  const [registerLastLoginIP, setRegisterLastLoginIP] = useState(24);

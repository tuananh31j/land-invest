...
export const CreateGroup = ( BoxName, Description, avatarLink) => {
    return instance.post(`/api/box/add_group/`,{BoxName, Description, avatarLink});
}

export const UpdateGroup = (GroupID, GroupName, Description, avatarLink) => {
    return instance.patch(`/api/box/update_group/${GroupID}`,{GroupName, Description, avatarLink});
}
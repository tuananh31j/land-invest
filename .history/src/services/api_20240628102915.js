...
export const callFetchPostById = ( GroupID, Title, Content, PostLatitude , PostLongitude) => {
    return instance.get('/api/forum/add_post',{GroupID, Title, Content, PostLatitude , PostLongitude});
}
...
const GroupModalUpdate = (props) => {
    ...
    console.log(">>> check dataUpdate group: ", dataUpdate group);
    ...
    const onFinish = async (values) => {
        ...
        console.log("dataUpdate.BoxID: ",dataUpdate.GroupID)
        setIsSubmit(true)
        const res = await UpdateBox(GroupID, GroupName);
        res.headers= {
...
export default GroupModalUpdate;
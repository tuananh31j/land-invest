                ...
                <Col className="content-center" xs={6}>
                    ...
                    {dataPost.Title && dataPost.Content && (
                        <div className="post-item">
                            ...
                            <hr
                                style={{ width: '100%', background: '#fff', height: '0.2px', border: 0, margin: 0 }}
                            ></hr>
                            ...
                            <div className="post-react">
                                <div className="post-react-icon">
                                    <BiSolidLike
                                        onClick={handleLike}
                                        className="icon-like"
                                        style={{ color: isLike ? '#1900ff' : '#C5D0E6' }}
                                    />
                                    <span>Like</span>
                                </div>
                                <div className="post-react-icon">
                                            ...
                                            {comment.UserID === userID && (
                                                <div className="cmt-actions">
                                                    <IoEllipsisVerticalCircleSharp
                                                        onClick={() => handleOpenModal(comment.CommentID)}
                                                    />
                                                    {openModal === comment.CommentID && (
                                                        <div className="modal-actions">
                                                            <p onClick={() => handleEdit(comment)}>Sửa</p>
                                                            <p onClick={() => handleDeleteComment(comment.CommentID)}>
                                                                Xóa{' '}
                                                            </p>
                                                        </div>
                                                    )}
